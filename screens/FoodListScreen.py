...
class FoodListScreen(gui_compenonts.Screen):
    def __init__(self, display, GameStateManager: "gui_compenonts.GameStateManager", bg_color: pygame.Color = BACKGROUND_COLOR):
        ...
        self.title_button = gui_compenonts.Button(self.title_menu, relative_padding=(.3, .3), bg_color=BUTTON_COLOR1, text='Food List', on_press=lambda: True, hover_highlight=1)
        self.title_menu.init_widgets() 
        
        self.back_menu = gui_compenonts.Menu(self.display, relative_size=(.2, .2), position='topleft')
        self.back_button = gui_compenonts.Button(self.back_menu, relative_padding=(.6,.7), bg_color=BUTTON_COLOR1, on_press=self.switch_to_main, text='Back')
        ...
        self.next_button = gui_compenonts.Button(self.next_menu, relative_padding=(.6,.7), bg_color=BUTTON_COLOR1, on_press=self.increase_index, text='Next')
        self.next_menu.init_widgets()
        
        self.previous_menu = gui_compenonts.Menu(self.display, relative_size=(.2, .2), position='bottomleft')
        self.previous_button = gui_compenonts.Button(self.previous_menu, relative_padding=(.6,.7), bg_color=BUTTON_COLOR1, on_press=self.decrease_index, text='Previous')
